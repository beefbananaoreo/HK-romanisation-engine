...
fixtures=json.loads((root/'obligations/case-fixtures.json').read_text())
coverage=json.loads((root/'obligations/coverage-map.json').read_text())
...
if '--record' in sys.argv:path.write_text(output)
